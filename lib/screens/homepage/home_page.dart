...
class _HomePageState extends State<HomePage> {
  ...
  Widget buildBody() {
    return BlocBuilder<RestaurantCubit, RestaurantsStates>(
      builder: (context, state) {
        if (state is GetRestLoadingError) {
          return Center(child: Text('Error', style: customTxtStyle(20, Colors.red),));
        } else if (state is GetRestLoading) {
